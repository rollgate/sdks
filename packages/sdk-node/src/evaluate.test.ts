  ...
  describe("condition operators", () => {
    ...
    describe("equals / not_equals", () => {
      it("equals - should match exact value (case insensitive)", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "hello" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "HELLO" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "world" } }),
        ).toBe(false);
      });
    ...
    describe("contains / not_contains", () => {
      it("contains - should match substring", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "no match" } }),
        ).toBe(false);
      });
    ...
    describe("starts_with / ends_with", () => {
      it("starts_with - should match prefix", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "hello world" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "world hello" } }),
        ).toBe(false);
      });
    ...
    describe("in / not_in", () => {
      it("in - should match value in list", () => {
        ...
        expect(evaluateFlag(rule, { id: "u", attributes: { test: "b" } })).toBe(
          true,
        );
        expect(evaluateFlag(rule, { id: "u", attributes: { test: "d" } })).toBe(
          false,
        );
      });
    ...
    describe("numeric comparisons", () => {
      it("greater_than", () => {
        ...
        expect(evaluateFlag(rule, { id: "u", attributes: { test: 15 } })).toBe(
          true,
        );
        expect(evaluateFlag(rule, { id: "u", attributes: { test: 10 } })).toBe(
          false,
        );
        expect(evaluateFlag(rule, { id: "u", attributes: { test: 5 } })).toBe(
          false,
        );
      });
      ...
      it("should handle string numbers", () => {
        const rule = createRule("greater_than", "10");
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "15" } }),
        ).toBe(true);
      });
      ...
      it("should return false for non-numeric values", () => {
        const rule = createRule("greater_than", "10");
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "abc" } }),
        ).toBe(false);
      });
    });
    ...
    describe("regex", () => {
      it("should match regex pattern", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "user-123" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "admin-123" } }),
        ).toBe(false);
      });
      ...
      it("should return false for invalid regex", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "test" } }),
        ).toBe(false);
      });
    });
    ...
    describe("semver comparisons", () => {
      it("semver_gt - greater than", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.3.0" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.2.1" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.2.0" } }),
        ).toBe(false);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.1.0" } }),
        ).toBe(false);
      });
      ...
      it("semver_lt - less than", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.9.9" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "2.0.0" } }),
        ).toBe(false);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "2.0.1" } }),
        ).toBe(false);
      });
      ...
      it("semver_eq - equal", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.0.0" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.0" } }),
        ).toBe(true);
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "1.0.1" } }),
        ).toBe(false);
      });
      ...
      it("should handle v prefix", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "v1.1.0" } }),
        ).toBe(true);
      });
      ...
      it("should return false for invalid semver", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "invalid" } }),
        ).toBe(false);
      });
    });
    ...
    describe("is_set / is_not_set", () => {
      it("is_set - should match when attribute exists", () => {
        ...
        expect(
          evaluateFlag(rule, { id: "u", attributes: { test: "value" } }),
        ).toBe(true);
        expect(evaluateFlag(rule, { id: "u", attributes: { test: 0 } })).toBe(
          true,
        );
      ...
      it("is_set - should treat empty string as not set", () => {
        const rule = createRule("is_set", "");
        expect(evaluateFlag(rule, { id: "u", attributes: { test: "" } })).toBe(
          false,
        );
      });
    });
    ...
    describe("special attributes", () => {
      ...
      it("should match email attribute", () => {
        ...
        expect(evaluateFlag(rule, { id: "u", email: "john@company.com" })).toBe(
          true,
        );
        expect(evaluateFlag(rule, { id: "u", email: "john@gmail.com" })).toBe(
          false,
        );
      });
    });
...
describe("evaluateFlagValue (V2)", () => {
  ...
  describe("json flags", () => {
    it("should return json value from variations", () => {
      ...
      const result = evaluateFlagValue<{ theme: string; limit: number }>(rule, {
        id: "user-1",
      });
      expect(result.enabled).toBe(true);
