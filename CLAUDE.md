...
| `test-harness/CONTRACT_TESTS.md` | Lista 102 contract tests           | Per debug test          |
...
packages/
  ...
  sdk-java/        → io.rollgate:rollgate-sdk (Maven Central)
...
test-harness/      → Cross-SDK contract tests (Go)
  ...
  internal/        → Test suite (102 tests)
```

---

## Pacchetti Pubblicati (v1.0.0)

| SDK | Registry | Package |
|-----|----------|---------|
| sdk-core | npm | `@rollgate/sdk-core` |
| sdk-node | npm | `@rollgate/sdk-node` |
| sdk-browser | npm | `@rollgate/sdk-browser` |
| sdk-react | npm | `@rollgate/sdk-react` |
| sdk-vue | npm | `@rollgate/sdk-vue` |
| sdk-angular | npm | `@rollgate/sdk-angular` |
| sdk-svelte | npm | `@rollgate/sdk-svelte` |
| sdk-react-native | npm | `@rollgate/sdk-react-native` |
| sdk-go | Go modules | `github.com/rollgate/sdk-go` (tag v1.0.0) |
| sdk-python | PyPI | `rollgate` |
| sdk-java | Maven Central | `io.rollgate:rollgate-sdk` |
| sdk-dotnet | NuGet | `Rollgate.SDK` |
| sdk-flutter | pub.dev | `rollgate` |

---

## Contract Tests & Dashboard

### Eseguire TUTTI i 1224 Contract Tests (12 SDK)
...
- Ogni SDK deve passare i 102 contract tests
...
## Staging (Contract Tests contro API reale)

> **L'ambiente staging per i contract test è su k3s homelab.**
> API: `http://192.168.1.212:30510` — Namespace `rollgate` su k3s (Proxmox container 102)

Per eseguire i contract test contro staging:
```bash
# Variabili d'ambiente necessarie:
# EXTERNAL_SERVER_URL=http://192.168.1.212:30510
# EXTERNAL_API_KEY=<api-key-staging>

# Il CI workflow è in .github/workflows/contract-tests-staging.yml
```

Dettagli completi: vedi sezione "AMBIENTE DI STAGING" in `C:\Projects\rollgate\CLAUDE.md`
