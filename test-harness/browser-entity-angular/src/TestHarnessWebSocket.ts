...
import { log, CreateInstanceParams, CommandParams } from "./types";
          ...
          case "createClient":
            {
              ...
              try {
                const params = data.body as CreateInstanceParams;
                params.tag = `angular-client-${clientId}`;
                const entity = await newSdkClientEntity(params);
